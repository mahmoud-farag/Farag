function About() {
    return (
        <section className="py-24 bg-gray-50 dark:bg-gray-800 transition-colors duration-300" id="about">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="flex-shrink-0">
                        <div className="relative group">
                            ...
                            <div className="relative w-64 h-64 md:w-80 md:h-80 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-700 overflow-hidden shadow-card">
                                <img
                                    src="/profile.jpg"
                                    alt="Mahmoud Farag"
                    ...
                    <div className="flex-1 text-center lg:text-left">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <div className="glass-card p-6 text-center">
                                ...
                                <span className="text-gray-500 dark:text-gray-400 text-sm">Technologies</span>
                            </div>
                        </div>
                    </div>
                </div>
